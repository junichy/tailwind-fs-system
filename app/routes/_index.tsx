...
import { GridItem, ResponsiveGrid } from '../components/ResponsiveGrid';
...
export const meta: MetaFunction = () => {
	return [
		...
		{
			name: 'description',
			content: 'Figma対応レスポンシブデザインシステムのデモ',
		},
	];
};
				...
				<nav className='container-custom py-4'>
					<div className='flex justify-between items-center'>
						<div className='flex items-center space-x-2'>
							...
							<div>
								<h1 className='fs-24 font-bold text-gray-800'>
									Tailwind FS System
								</h1>
						...
						<nav className='hidden md:flex space-x-8'>
							<Link
								to='/basic-usage'
								className='fs-16 text-gray-700 hover:text-blue-600 transition-colors'
							>
								基本的な使い方
							</Link>
							<Link
				...
				<section className='py-fs-80 bg-white'>
					<div className='container-custom'>
						<div className='text-center mb-fs-64'>
							<h2 className='fs-36 font-bold text-gray-900 mb-fs-16'>
								主な機能
							</h2>
							<p className='fs-16 text-gray-600'>
								Figmaデザインをそのままコードで実現
							</p>
						</div>
						...
						<div className='grid md:grid-cols-3 gap-fs-40'>
							...
							<div className='text-center p-fs-32 rounded-fs-16 bg-gradient-to-b from-blue-50 to-blue-100'>
								...
								<h3 className='fs-20 font-bold text-gray-900 mb-fs-16'>
									fs関数
								</h3>
								...
								<div className='bg-gray-100 rounded-fs-8 p-fs-16'>
									<code className='fs-12 text-gray-700'>
										{'className="w-fs-300 p-fs-32"'}
									</code>
								</div>
							</div>
				...
				<section className='py-fs-80 bg-gray-50'>
					<div className='container-custom'>
						<div className='text-center mb-fs-64'>
							...
							<p className='fs-16 text-gray-600'>
								ブラウザのサイズを変更して、レスポンシブ動作を確認してください
							</p>
						</div>
						...
						<div className='bg-white rounded-fs-16 p-fs-32 shadow-lg'>
							...
							<div className='space-y-fs-16'>
								<div className='fs-48 font-bold text-blue-600'>
									fs-48: 大見出し
								</div>
								<div className='fs-36 font-bold text-gray-900'>
									fs-36: 中見出し
								</div>
								<div className='fs-24 font-semibold text-gray-800'>
									fs-24: 小見出し
								</div>
			...
			<footer className='bg-gray-900 text-white py-fs-64'>
				<div className='container-custom text-center'>
					...
					<div className='flex flex-wrap justify-center gap-fs-32 mb-fs-32'>
						<Link
							to='/basic-usage'
							className='fs-14 hover:text-blue-400 transition-colors'
						>
							基本的な使い方
						</Link>
						<Link
